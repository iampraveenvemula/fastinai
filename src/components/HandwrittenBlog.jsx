  ...
  return (
    <div style={{ background: '#263238', color: '#ffffff', minHeight: '100vh', padding: '60px 0' }}>
       <div style={{ textAlign: 'center', marginBottom: '10vh' }}>
          <Scene margin="0%">
             <DrawText as="h1" text="Inside the Machine" duration={2} style={{ fontSize: '4rem', fontFamily: "'Kalam', cursive", color: '#fef08a' }} />
             <br />
       ...
       <Scene>
          <div style={{ textAlign: 'center', marginTop: '10vh' }}>
             <DrawText as="h3" text="The End" duration={1.5} style={{ fontSize: '2rem', color: 'rgba(255,255,255,0.4)', fontFamily: "'Kalam', cursive" }} />
          </div>
       </Scene>
    </div>
  );
